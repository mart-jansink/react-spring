...
var El = reactSpring.Globals.defaultElement
var AnimatedDiv = reactSpring.animated(El)
...
var ParallaxLayer =
  ...
  (function(_React$PureComponent) {
    ...
    _proto.initialize = function initialize() {
      ...
      this.controller = new reactSpring.Controller({
  ...
  (function(_React$PureComponent2) {
    ...
    function Parallax(props) {
      ...
      _this3.scrollerRaf = function() {
        return reactSpring.Globals.requestFrame(_this3.moveItems)
      }
      ...
      _this3.updateRaf = function() {
        reactSpring.Globals.requestFrame(_this3.update) // Some browsers don't fire on maximize
      ...
      _this3.offset = 0
      _this3.busy = false
      _this3.controller = new reactSpring.Controller({
        scroll: 0,
      })
      return _this3
    }
